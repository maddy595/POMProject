...
public class WebDriverActionLogs extends BasePage implements WebDriverEventListener{
	...
	public void afterNavigateTo(String url, WebDriver driver) {
		System.out.println("Navugated to");
	...
	public void beforeGetText(WebElement element, WebDriver driver) {
		System.out.println("About to get Text");
